    ...
    <div class="header1hello">
        ...
        <mu-drawer :open="open" :docked="docked" @close="toggle()" class="navleft">
            <mu-list @itemClick="docked ? '' : toggle()">
                ...
                <mu-list-item title="修改密码" @click="JumpTo(4)"><mu-icon value="person" class="navlefticon"></mu-icon></mu-list-item>
                <mu-list-item @click.native="open = false" title="收回"><mu-icon value="chevron_left" class="navlefticon"></mu-icon></mu-list-item>
            </mu-list>
        </mu-drawer>
        <mu-drawer :open="open1" :docked="docked1" @close="toggle1()" class="navright" :right="right1">
            <mu-list @itemClick="docked1 ? '' : toggle1()">
                <mu-list-item title="添加"><mu-icon value="add_circle_outline" class="navrighticon"></mu-icon></mu-list-item>
                <mu-list-item v-if="docked1" @click.native="open1 = false" title="收回"><mu-icon value="chevron_right" class="navrighticon"></mu-icon></mu-list-item>
            </mu-list>
        </mu-drawer>
    </div>
</template>
