...
import { sparePartsOptionType, firmType, dictionary } from '@/common/js/dictionary.js'
...
export default {
  ...
  created () {
    ...
    // 事务原因列表
    apiAuth.getSubCode(sparePartsOptionType.receive).then(res => {
  ...
  methods: {
    ...
    save () {
      ...
      let stockReceive = {
        Type: sparePartsOptionType.receive,
