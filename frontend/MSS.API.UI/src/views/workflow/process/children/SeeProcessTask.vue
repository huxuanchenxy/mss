  ...
  <div class="wrap height-full"
    ...
    <div class="content-wrap">
      <ul class="content-header">
        ...
        <li class="list number c-pointer" @click="changeOrder('appName')">
          流程名称
       ...
       <li class="list number c-pointer" @click="changeOrder('appInstanceID')" style="display:none;">
        ...
        <li class="list number c-pointer" @click="changeOrder('activityName')" >
          步骤名称
        ...
        <li class="list number c-pointer" @click="changeOrder('createdDateTime')">创建日期
          ...
          <ul class="list-wrap">
            <li class="list" v-for="(item) in DataList" :key="item.key">
              <div class="list-content">
                ...
                <div class="number">{{ item.appName }}</div>
                <!--<div class="name">
                ...
                <div class="number">{{ item.activityName }}</div>
                <!-- <div class="name">{{ item.mac_add }}</div> -->
                <div class="number">{{ item.createdDateTime }}</div>
